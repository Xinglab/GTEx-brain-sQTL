...
#example input:
#sys.argv=['nothing','/u/nobackup/yxing/PROJECT/yidazhan/research/rotation_project/GTEx_brain_project_V7/analysis/6_sQTL_analysis/sQTL_run/logit/JC/SE/Brain-Cortex/selected.sQTL.glmm.Glimmps_each_exon_cis_Brain-Cortex.pvalue.txt']
...
fin_list=glob.glob('/u/nobackup/yxing/NOBACKUP/sstein93/1000GenomesVCF/VCF/plink_allsnps/CEU.plink.*.tped')
