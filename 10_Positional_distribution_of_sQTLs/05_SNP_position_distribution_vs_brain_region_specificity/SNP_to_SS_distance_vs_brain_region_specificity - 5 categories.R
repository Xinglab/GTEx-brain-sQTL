...
#then we pick the best category based on this order: dinucleotide, splice site range, exon body, <=300bp, >300bp, i.e., if there is one on the dinucleotide range, this exon is considered this category no matter the rest of the 12 categories
#3. When we make the plot, each exon will have two information: 
#one category: we choose one from the 13 categories in this order: dinucleotide, splice site range, exon body, <=300bp, >300bp
