...
type="pvalue"
Rscript $code_folder/SNP_distribution.R $splicetype $counttype $PSItype $splicing_input $summaryinput $rootsqtl $outputpath $type $totalcountinput $GWASdbpath $GWASdbname $genoplinkprefix $LDpath
